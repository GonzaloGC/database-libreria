...
CREATE TABLE usuarios(
    ...
    fecha_creacion DATETIME DEFAULT CURRENT_TIMESTAMP 
    -- CURRENT_TIMESTAMP LO UTILIZAMOS PARA AGREGAR LA FECHA Y HORA ACTUAL
);
...
INSERT INTO autores (nombre, apellido, seudonimo, fecha_nacimiento, genero, nacionalidad)
VALUES              ('Stephrn Edwin', 'King', 'Richard Bachman', '1947-09-27', 'M', 'USA'),
...
VALUES               ("Gonzalo", "Guerrero", "gonzaloelias", "Gonzalo@mail.com"),
                     ("Matias", "Guerrero", "matig", "matias@mail.com"),
                     ("Ignacio", "Guerrero", "nachog", "ignacio@mail.com"),
                     ("Elias", "Guerrero", "eliasg", "elias@mail.com");
